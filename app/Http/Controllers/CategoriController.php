...
class CategoriController extends Controller
{
    public function car()
    {
        ...
        return view('categori.car', compact('title', 'posts'));
    }
    public function home()
    {
        $title = 'Home Page';
        $posts = Post::orderBy('id', 'desc')->get();
        return view('categori.home', compact('title', 'posts'));
    }
    public function services()
    {
        $title = 'Services Page';
        $posts = Post::orderBy('id', 'desc')->get();
        return view('categori.services', compact('title', 'posts'));
    }
